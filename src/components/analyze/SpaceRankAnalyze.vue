...
import 'echarts'
import {ref, withDefaults, defineProps, computed, watchEffect} from 'vue'
import { message } from 'ant-design-vue'
import {getSpaceCategoryAnalyzeUsingPost, getSpaceRankAnalyzeUsingPost} from '@/api/spaceAnalyzeController.ts'
